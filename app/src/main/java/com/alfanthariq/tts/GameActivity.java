...
import com.alfanthariq.tts.adapter.GridItemView;
import com.alfanthariq.tts.adapter.TextDrawable;
import com.alfanthariq.tts.fragment.MendatarFragment;
import com.alfanthariq.tts.fragment.MenurunFragment;
...
public class GameActivity extends AppCompatActivity
    ...
    private AutofitTextView title_app, txtQuest;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtQuest = (AutofitTextView) findViewById(R.id.txtQuestion);
    ...
    private void blockBox(int row, int col, int color){
        ...
        if (valid) {
            ...
            if (questData.getCount()>0) {
                ...
                txtQuest.setText("Silahkan pilih kolom atau baris");
            }
            questData.close();
            mDbHelper.close();
        }
